...
lyr_test43_4.set('fieldAliases', {'地區': '地區', '國家': '國家', '名稱': '名稱', '材料': '材料', '功能': '功能', '類型': '類型', '風格': '風格', '外形': '外形', '檐': '檐', '屋頂類型': '屋頂類型', '面寬': '面寬', '開間': '開間', '結構2': '結構2', '斗拱': '斗拱', '出跳': '出跳', '宗教': '宗教', '等級': '等級', '長': '長', '寬': '寬', '高': '高', '公元': '公元', '年份': '年份', '政權': '政權', '時代': '時代', '年代斷定': '年代斷定', '狀態': '狀態', '始建': '始建', '地址': '地址', '注(現存)': '注(現存)', '經度': '經度', '緯度': '緯度', });
...
lyr_test43_4.set('fieldImages', {'地區': '', '國家': '', '名稱': '', '材料': '', '功能': '', '類型': '', '風格': '', '外形': '', '檐': '', '屋頂類型': '', '面寬': '', '開間': '', '結構2': '', '斗拱': '', '出跳': '', '宗教': '', '等級': '', '長': '', '寬': '', '高': '', '公元': '', '年份': '', '政權': '', '時代': '', '年代斷定': '', '狀態': '', '始建': '', '地址': '', '注(現存)': '', '經度': '', '緯度': '', });
...
lyr_test43_4.set('fieldLabels', {'地區': 'no label', '國家': 'no label', '名稱': 'no label', '材料': 'hidden field', '功能': 'no label', '類型': 'no label', '風格': 'no label', '外形': 'no label', '檐': 'hidden field', '屋頂類型': 'hidden field', '面寬': 'no label', '開間': 'hidden field', '結構2': 'no label', '斗拱': 'no label', '出跳': 'hidden field', '宗教': 'no label', '等級': 'inline label - always visible', '長': 'inline label - always visible', '寬': 'inline label - always visible', '高': 'inline label - always visible', '公元': 'inline label - always visible', '年份': 'inline label - always visible', '政權': 'inline label - always visible', '時代': 'inline label - always visible', '年代斷定': 'inline label - always visible', '狀態': 'inline label - always visible', '始建': 'inline label - always visible', '地址': 'no label', '注(現存)': 'no label', '經度': 'hidden field', '緯度': 'hidden field', });
