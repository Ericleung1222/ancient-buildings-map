...
lyr_test43_4.set('fieldAliases', {'地區': '地區', '國家': '國家', '名稱': '名稱', '材料': '材料', '功能': '功能', '類型': '類型', '風格': '風格', '外形': '外形', '檐': '檐', '屋頂類型': '屋頂類型', '面寬': '面寬', '開間': '開間', '結構2': '結構2', '斗拱': '斗拱', '出跳': '出跳', '宗教': '宗教', '等級': '等級', '長': '長', '寬': '寬', '面積': '面積', '高': '高', '公元': '公元', '年份': '年份', '政權': '政權', '時代': '時代', '年代斷定': '年代斷定', '狀態': '狀態', '始建': '始建', '地址': '地址', '注(現存)': '注(現存)', '經度': '經度', '緯度': '緯度', });
...
lyr_test43_4.set('fieldImages', {'地區': '', '國家': '', '名稱': '', '材料': '', '功能': '', '類型': '', '風格': '', '外形': '', '檐': '', '屋頂類型': '', '面寬': '', '開間': '', '結構2': '', '斗拱': '', '出跳': '', '宗教': '', '等級': '', '長': '', '寬': '', '面積': '', '高': '', '公元': '', '年份': '', '政權': '', '時代': '', '年代斷定': '', '狀態': '', '始建': '', '地址': '', '注(現存)': '', '經度': '', '緯度': '', });
