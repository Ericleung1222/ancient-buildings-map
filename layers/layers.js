...
lyr_test43_4.set('fieldLabels', {'地區': 'no label', '國家': 'no label', '名稱': 'no label', '材料': 'no label', '功能': 'no label', '類型': 'no label', '風格': 'no label', '外形': 'no label', '檐': 'hidden field', '屋頂類型': 'hidden field', '面寬': 'no label', '開間': 'hidden field', '結構2': 'no label', '斗拱': 'no label', '出跳': 'hidden field', '宗教': 'no label', '等級': 'inline label - always visible', '長': 'inline label - always visible', '寬': 'inline label - always visible', '高': 'inline label - always visible', '公元': 'inline label - always visible', '年份': 'inline label - always visible', '政權': 'inline label - always visible', '時代': 'inline label - always visible', '年代斷定': 'inline label - always visible', '狀態': 'inline label - always visible', '始建': 'hidden field', '地址': 'no label', '注(現存)': 'no label', '經度': 'hidden field', '緯度': 'hidden field', });
